...
// Importing the assets you just moved
                ...
                <tr key={idx} className="group hover:bg-slate-50/30 transition-all">
                  <td className="p-7">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-400 mt-1">
                        {lead.headcount} team members • Founded {lead.founded_year}
                      </span>
                    </div>
                  </td>
                  <td className="p-7">
                  ...
                  <td className="p-7">
                    <div className="flex justify-end gap-2 pr-4">
                      <a href={lead.website_url} target="_blank" rel="noreferrer" className="px-5 py-2.5 bg-white border border-slate-200 text-slate-600 text-[10px] font-bold rounded-xl hover:border-[#FF5C35] hover:text-[#FF5C35] transition-all shadow-sm uppercase tracking-tighter">
                        Website
                      </a>
                      <a href={lead.linkedin_url} target="_blank" rel="noreferrer" className="px-5 py-2.5 bg-[#FF5C35] text-white text-[10px] font-bold rounded-xl hover:shadow-lg hover:shadow-[#FF5C35]/30 transition-all shadow-sm uppercase tracking-tighter">
                        LinkedIn
                      </a>
                    </div>
                  </td>
